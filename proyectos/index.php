...
$ejercicios = array(
    array('id' => 1, 'titulo' => 'Buscaminas', 'descripcion' => 'Crea el juego del buscaminas.  El tablero está dividido en celdas, con minas distribuidas al azar. Para ganar, debes abrir todas las celdas que no contienen minas.', 'enlace' => 'buscaminas/index.php', 'github' => 'https://github.com/viorbe20/DWES_2021_2022/blob/main/proyectos/buscaminas/index.php'),
    ...
    array('id' => 5, 'titulo' => 'Sopa de Letras (Modo Vista Controlador)', 'descripcion' => 'Aplicación con sesiones invitado y admin. El invitado puede buscar ciudades y el admin además crearlas, editarlas y eliminarlas.', 'enlace' => '', 'github' => 'https://github.com/viorbe20/DWES_2021_2022/blob/main/db/wordsearchV3/public/index.php'),
    array('id' => 6, 'titulo' => 'Bookmarks', 'descripcion' => 'Aplicación que permite al usuario crear y gestionar marcadores. El usuario debe registrarse y el admin debe autorizarla.', 'enlace' => '/bookmarks/public/index.php/home', 'github' => 'https://github.com/viorbe20/DWES_2021_2022/blob/main/proyectos/bookmarks/public/index.php'),
    array('id' => 7, 'titulo' => 'Encuestas', 'descripcion' => 'Aplicación que muestra diversas encuestas para rellenar.', 'enlace' => '/bookmarks/public/index.php/home', 'github' => 'https://github.com/viorbe20/DWES_2021_2022/blob/main/proyectos/bookmarks/public/index.php'),
);
?>
