...
$ejercicios = array(
    ...
    array('id' => 6, 'titulo' => 'Almacena números', 'descripcion' => 'Escribe un script donde se almacenen tres números en variables. Esos números deben aparecer por pantalla de manera ordenada.', 'enlace' => 'ej6.php', 'github' => 'https://github.com/viorbe20/DWES_ud3_act1/blob/main/ej6.php'),
    array('id' => 7, 'titulo' => 'Días del mes', 'descripcion' => 'Escribe un script en el que se pueda introducir un mes y año. Aparecerá un mensaje que debe indicar los días que tiene ese mes en concreto.', 'enlace' => 'ej7.php', 'github' => 'https://github.com/viorbe20/DWES_ud3_condiciones/blob/main/ej7.php'),
    array('id' => 8, 'titulo' => 'Calcula edad', 'descripcion' => 'Escribe un script en el que se pueda introducir una fecha. A partir de ella, debe aparecer un mensaje indicando la edad', 'enlace' => 'ej8.php', 'github' => 'https://github.com/viorbe20/DWES_ud3_act1/blob/main/ej8.php'),
